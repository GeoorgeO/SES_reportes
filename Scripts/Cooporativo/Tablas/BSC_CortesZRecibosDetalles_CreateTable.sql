...
ELSE
	begin
		...
		ALTER TABLE [dbo].[CortesZRecibosDetalles]  WITH CHECK ADD  CONSTRAINT [FK_CortesZRecibosDetalles_CortesZRecibos] FOREIGN KEY([CortesZRecibosId])
		REFERENCES [dbo].[CortesZRecibos] ([CortesZRecibosId])
		

		ALTER TABLE [dbo].[CortesZRecibosDetalles] CHECK CONSTRAINT [FK_CortesZRecibosDetalles_CortesZRecibos]
