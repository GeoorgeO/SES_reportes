...
BEGIN
	...
	and rtrim(CanArt.CancelacionId)+rtrim(CanArt.CajaId)+rtrim(CanArt.CancelacionArticuloUltimoIde) not in(SELECT rtrim(CanArtS.CancelacionId)+rtrim(CanArtS.CajaId)+rtrim(CanArtS.CancelacionArticuloUltimoIde) FROM [SERVER-SON].[Server_SarabiaII].[dbo].[CancelacionArticulo] as CanArtS
	inner join [SERVER-SON].[Server_SarabiaII].[dbo].[Cancelacion] as CanS
...
BEGIN
	...
	and CancelacionId not in(SELECT CancelacionId FROM [SERVER-SON].[Server_SarabiaII].[dbo].[Cancelacion]
...
BEGIN
	...
	FROM [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZRecargasTickets] as CRdetS
	left join [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZRecargas] as CRS on CRS.CajaId=CRdetS.CajaId and CRS.CortesZRecargasId=CRdetS.CortesZRecargasId
...
BEGIN
	...
	and czr.CortesZRecargasId not in(SELECT czrS.CortesZRecargasId FROM [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZRecargas] as czrS
...
BEGIN
	...
	FROM  [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZRecibosDetalles] as CRdetS
	left join [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZRecibos] as CRS on CRS.CortesZRecibosId=CRdetS.CortesZRecibosId
...
BEGIN
	...
	FROM          [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZRecibos] as czrS
...
BEGIN
	...
	and CortesZId not in(SELECT czS.CortesZId FROM [SERVER-SON].[Server_SarabiaII].[dbo].[CortesZ] as czS
...
BEGIN
	...
	SELECT rtrim(DevArtS.DevolucionId)+rtrim(DevArtS.CajaId)+rtrim(DevArtS.DevolucionArticuloUltimoIde)
 	from [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionArticulo] as DevArtS
	inner join [SERVER-SON].[Server_SarabiaII].[dbo].[Devolucion] as DevS
...
BEGIN
	...
	FROM  [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionMayoreoArticulo]    as dmArtS INNER JOIN
          [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionMayoreo]       as dmS ON dmArtS.DevolucionId = dmS.DevolucionId AND dmArtS.CajaId = dmS.CajaId
...
BEGIN
	...
	FROM  [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionMayoreo] AS DevMayS
...
BEGIN
	...
	FROM [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionPreDetalles] as DPdetS
	left join [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionPre] as DPS on DPS.DevolucionPreId=DPdetS.DevolucionPreId
...
BEGIN
	...
	FROM          [SERVER-SON].[Server_SarabiaII].[dbo].[DevolucionPre] as DpS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].[Devolucion] as devS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].[EntradaMercancia]  as EMS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].RecibosRemisiones as RRS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].SalidaMercanciaArticulo as SalMerArtS
	inner join [SERVER-SON].[Server_SarabiaII].[dbo].SalidaMercancia as SalMerS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].SalidaMercancia as sS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].TicketArticulo as TicArtS
	inner join [SERVER-SON].[Server_SarabiaII].[dbo].Ticket as TicS
...
BEGIN
	...
	from [SERVER-SON].[Server_SarabiaII].[dbo].TicketMayoreoArticulo as TicMayArtS
	inner join [SERVER-SON].[Server_SarabiaII].[dbo].TicketMayoreo as TicMayS
...
BEGIN
	...
	select tmS.TicketId
	from [SERVER-SON].[Server_SarabiaII].[dbo].TicketMayoreo as tmS
...
BEGIN
	...
	SELECT tS.TicketId
	from [SERVER-SON].[Server_SarabiaII].[dbo].Ticket as tS
