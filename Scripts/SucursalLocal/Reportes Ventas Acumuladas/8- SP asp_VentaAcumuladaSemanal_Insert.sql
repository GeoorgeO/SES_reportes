...
/****** Object:  StoredProcedure [dbo].[asp_VentaAcumuladaSemanal_Insert]    Script Date: 29/01/2019 05:42:29 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
IF  EXISTS (SELECT * FROM SYS.OBJECTS WHERE TYPE = 'P' AND NAME = 'asp_VentaAcumuladaSemanal_Insert')
DROP PROCEDURE asp_VentaAcumuladaSemanal_Insert
GO
CREATE PROCEDURE [dbo].[asp_VentaAcumuladaSemanal_Insert]
	@Opcion int
AS
BEGIN
...
exec asp_FechaAñoAnterior_Select @FechaDomingoActual , @Opcion , @FechaDomingoAnterior output
exec asp_FechaAñoAnterior_Select @FechaSabadoActual , @Opcion , @FechaSabadoAnterior output
exec asp_FechaAñoAnterior_Select @FechaViernesActual , @Opcion , @FechaViernesAnterior output
exec asp_FechaAñoAnterior_Select @FechaJuevesActual , @Opcion , @FechaJuevesAnterior output
exec asp_FechaAñoAnterior_Select @FechaMiercolesActual , @Opcion , @FechaMiercolesAnterior output
exec asp_FechaAñoAnterior_Select @FechaMartesActual , @Opcion , @FechaMartesAnterior output
exec asp_FechaAñoAnterior_Select @FechaLunesActual ,  @Opcion , @FechaLunesAnterior output
