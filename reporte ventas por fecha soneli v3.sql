--select ArticuloCodigo,Existencia,ArticuloCosto,ArticuloIva from server_Apatzingan.dbo.Articulokardex where FechaExistencia= (select max(FechaExistencia) from server_Apatzingan.dbo.Articulokardex)
--select * from central.dbo.Articulo
...
set @FechaFin = '20180531 23:59:59'
set @ProveedorId=54
...
order by ExiApa.Existencia desc