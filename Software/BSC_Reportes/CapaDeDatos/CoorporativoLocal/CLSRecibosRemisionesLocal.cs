...
{
    public class CLSRecibosRemisionesLocal : ConexionBase
    {

        public string FechaFin { get; set; }
        public string FechaInicio { get; set; }

        public void MtdSeleccionarRecibosRemisiones()
        {
            TipoDato _dato = new TipoDato();
            Exito = true;
            try
            {
                _conexion.NombreProcedimiento = "asp_RecibosRemisiones_Select";
