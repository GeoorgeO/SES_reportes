...
{
    public class CLSCortesZRecibosDetallesLocal : ConexionBase
    {
        public string FechaFin { get; set; }
        public string FechaInicio { get; set; }

        public void MtdSeleccionarCortesZRecibosDetalles()
        {
            TipoDato _dato = new TipoDato();
            Exito = true;
            try
            {
                _conexion.NombreProcedimiento = "asp_CortesZRecibosDetalles_Select";
