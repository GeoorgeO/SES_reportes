...
{
    public class CLSSalidaMercanciaArticuloLocal : ConexionBase
    {

        public string FechaFin { get; set; }
        public string FechaInicio { get; set; }

        public void MtdSeleccionarSalidaMercanciaArticulo()
        {
            TipoDato _dato = new TipoDato();
            Exito = true;
            try
            {
                _conexion.NombreProcedimiento = "asp_SalidaMercanciaArticulo_Select";
