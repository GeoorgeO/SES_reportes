...
{
    public class CLSCorteZRecargasTicketsLocal : ConexionBase
    {
        public string FechaFin { get; set; }
        public string FechaInicio { get; set; }

        public void MtdSeleccionarCorteZRecargasTickets()
        {
            TipoDato _dato = new TipoDato();
            Exito = true;
            try
            {
                _conexion.NombreProcedimiento = "asp_CortesZRecargasTickets_Select";
