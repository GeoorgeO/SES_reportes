...
{
    public class CLS_Familia_central: ConexionBase
    {
        ...
        public string FamiliaTipo { get; set; }
        public string FamiliaActivo { get; set; }
        ...
        public void MtdActualizarFamilia()
        {
            ...
            try
            {
                ...
                _dato.CadenaTexto = FamiliaTipo;
                _conexionC.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "FamiliaTipo");
                _dato.CadenaTexto = FamiliaActivo;
                _conexionC.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "FamiliaActivo");
