...
{
    public class CLS_Vendedor_Central: ConexionBase
    {
        public int VendedorId { get; set; }
        public string VendedorNombre { get; set; }
        public string VendedorApellidos { get; set; }
        public string VendedorActivo { get; set; }
        ...
        public void MtdActualizarVendedor()
        {
            ...
            try
            {
                ...
                _dato.CadenaTexto = VendedorActivo;
                _conexionC.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "VendedorActivo");
