...
{
    public partial class rpt_InventarioCiego_Finalizado : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_InventarioCiego_Finalizado(long InventarioCiegoFolio)
        {
            InitializeComponent();
